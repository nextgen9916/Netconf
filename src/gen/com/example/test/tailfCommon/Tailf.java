...
public class Tailf {
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "gen.com.example.test.tailfCommon");
    ...
    public static void registerSchema() throws JNCException {
        ...
        parser.readFile("src/gen/com/example/test/tailfCommon/Tailf.schema", h);
    }
