 ...
 * the namespace 
 * generated to "src/gen/com/example/test/inet/ietfInetTypes/ip-address"
 * <p>
 * See line 179 in
...
public class IpAddress extends YangUnion {
    ...
    public IpAddress(String value) throws YangException {
        super(value,
            new String[] {
                "gen.com.example.test.inet.ietfInetTypes.Ipv4Address",
                "gen.com.example.test.inet.ietfInetTypes.Ipv6Address",
            }
        );
        check();
    }
