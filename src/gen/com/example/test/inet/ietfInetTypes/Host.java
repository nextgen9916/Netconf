 ...
 * the namespace 
 * generated to "src/gen/com/example/test/inet/ietfInetTypes/host"
 * <p>
 * See line 408 in
...
public class Host extends YangUnion {
    ...
    public Host(String value) throws YangException {
        super(value,
            new String[] {
                "gen.com.example.test.inet.ietfInetTypes.IpAddress",
                "gen.com.example.test.inet.ietfInetTypes.DomainName",
            }
        );
        check();
    }
