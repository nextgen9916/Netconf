 ...
 * the namespace 
 * generated to "src/gen/com/example/test/ietfInetTypes/ip-address-no-zone"
 * <p>
 * See line 248 in
...
public class IpAddressNoZone extends YangUnion {
    ...
    public IpAddressNoZone(String value) throws YangException {
        super(value,
            new String[] {
                "gen.com.example.test.ietfInetTypes.Ipv4AddressNoZone",
                "gen.com.example.test.ietfInetTypes.Ipv6AddressNoZone",
            }
        );
        check();
    }
